...
namespace ProjectEuler
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Answer for Problem 2 is " + SumOfEvenFibonacciBelow().ToString() + ".");
            Console.Read();            
        }
        ...
        /// </summary>
        /// <param name="cap">Variable for the upper cap (e.g. 4000000 in the question)</param>
        /// <returns>The sum of the even-valued terms</returns>
        private static long SumOfEvenFibonacciBelow(int cap = 4000000)
        {
            int x = 1;
            int y = 2;
            int sum = 0;
